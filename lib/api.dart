...
///
/// If it wold be more, we could keep a list of [Categories] here.
const apiCategory = {
  'name': 'Currency',
  'route': 'currency',
};
...
/// tides change often.
/// Here is an API that retrieves a list of currencies and their current
...
class Api {
  /// Here `dart:io` is used for HttpClient. More details: https://flutter.io/networking/
